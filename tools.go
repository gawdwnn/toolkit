...
const randomStringsSource = "abcdefghijklmnopqrstuvwxyz"
...
func (t *Tools) RandomString(n int) string {
	s, r := make([]rune, n), []rune(randomStringsSource)
	for i := range s {
...
func (t *Tools) UploadFiles(r *http.Request, uploadDir string, rename ...bool) ([]*UploadedFile, error) {
	...
	if err != nil {
		return nil, errors.New("the uploaded files is too big")
	}
...
// Slugify is a simple function to generate a slug from a string
